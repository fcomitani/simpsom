...
pal20 = ['#e6194B', '#3cb44b', '#ffe119', '#4363d8', '#f58231', 
...
def scatter_on_map(datagroups, centers, polygons_class,
                    color_val=None,
                    show=True, print_out=False, 
                    file_name="./som_scatter.png",
                    **kwargs):
    ...
    for i,group in enumerate(datagroups):
        ax.scatter(group[:,0], group[:,1], 
                color=pal20[i%20], edgecolor="#ffffff", 
